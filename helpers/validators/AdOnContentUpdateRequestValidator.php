...
class AdOnContentUpdateRequestValidator
{
    /**
     * @throws \Exception
     */
    ...
    private static function idValidation(Request $request): void
    {
        if(!$request->has('id') || empty($request->get('id'))){
            throw new \Exception("content identification missing to update");
        }
    }


    private static function templateValidation(Request $request): void
    {
    ...
    private static function titleValidation(Request $request): void
    {
        $error = [];
