            ...
            <div class="col-12 row gap-3 <?= $_GET["id"] > 11 ? "d-none" : "" ?>">
                ...
                <div class="col-md-8 col-12 d-flex flex-wrap justify-content-between">
                    <dl>
                        ...
                        <dd><a href="<?= url("/connector") ?>?id=2"
                               class="link <?= $_GET["id"] == 2 ? "selected" : "color-black" ?>">Omega corner
                                connectors</a></dd>
                        <dd><a href="<?= url("/connector") ?>?id=3"
                               class="link <?= $_GET["id"] == 3 ? "selected" : "color-black" ?>">T connectors</a></dd>
                        <dd><a href="<?= url("/connector") ?>?id=4"
                               class="link <?= $_GET["id"] == 4 ? "selected" : "color-black" ?>">Cross connectors</a>
                        </dd>
                    ...
                    <dl>
                        ...
                        <dd><a href="<?= url("/connector") ?>?id=7"
                               class="link <?= $_GET["id"] == 7 ? "selected" : "color-black" ?>">US T connectors</a>
                        </dd>
                        <dd><a href="<?= url("/connector") ?>?id=8"
                               class="link <?= $_GET["id"] == 8 ? "selected" : "color-black" ?>">US Cross connectors</a>
                        </dd>
                    ...
                    <dl>
                        ...
                        <dd><a href="<?= url("/connector") ?>?id=11"
                               class="link <?= $_GET["id"] == 11 ? "selected" : "color-black" ?>">CF weld-on
                                connector</a></dd>
                    </dl>
