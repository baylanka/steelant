...
<div class="jumbotron">
    ...
    <h5 class="connector-heading my-4">More than 25 years of experience in creati ng connectors for steel walls
    </h5>
    <div class="divider"></div>


    <p class="w-50 mt-5" style="font-size: 0.9rem;">
    ...
    <p class="w-50 mt-5" style="font-size: 0.8rem;">
        ...
        are simply unbeatable from an economic efficiency point of view.
    </p>
