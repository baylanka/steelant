    ...
    <div class="responsive-wrap">
        ...
        <div class="row justify-content-start mt-5">
            <div class="col-12 col-md-6">
                <p>
                    <?=Translate::get('privacy','contact_details')?><br/><br/>

                    <?=Translate::get('privacy','controller')?> <?=Translate::get('privacy','controller_detail')?><br/><br/><br/>
                    ...
                    web server, which will be stored as log files for a limited period and automatically erased after
                    24
                    months. This includes the following data:<br/><br/>

                    - IP address of the computer accessing the website<br/><br/>
                    - Date and time of website access<br/><br/>
                    ...
                    <?=Translate::get('privacy','purposes')?><br/><br/>
                    <?=Translate::get('privacy','purpose_detail')?><br/><br/><br/>

                    <?=Translate::get('privacy','legal_basis')?><br/><br/>
                    ...
                    <?=Translate::get('privacy','newsletter')?><br/><br/><br/>

                    You have the possibility to subscribe to our newsletter via our website. To that end,
                    we required your email address and your declaration of consent to receiving our
                    newsletter.<br/><br/>


                    You can unsubscribe from our newsletter at any time. Please send your unsubscribe request
                    ...
                    <?=Translate::get('privacy','cookies')?><br/><br/><br/>
                    ...
                    before as regards their web browser. However, these cookies are erased after a pre-determined period
                    of time.<br/><br/><br/>
