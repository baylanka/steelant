<div class="tab-pane fade p-2" id="template" role="tabpanel" aria-labelledby="contact2-tab">
    <div class="template-setting-container">
        <nav>
            <div class="nav nav-tabs justify-content-center mt-5" id="nav-tab" role="tablist">
                <button class="nav-link active" id="nav-de-tab" data-bs-toggle="tab" data-bs-target="#nav-de"
                        type="button" role="tab" aria-controls="nav-de" aria-selected="true">
                ...
                <button class="nav-link" id="nav-fr-tab" data-bs-toggle="tab" data-bs-target="#nav-fr" type="button"
                        role="tab" aria-controls="nav-fr" aria-selected="false">
                    <img src="<?= assets("img/flags/fr.png") ?>" height="25" class="flag"/>
                </button>

                <button class="nav-link" id="nav-us-tab" data-bs-toggle="tab" data-bs-target="#nav-us" type="button"
                        role="tab" aria-controls="nav-us" aria-selected="false">
