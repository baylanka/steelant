<div class="modal-dialog modal-fullscreen">
    <div class="modal-content">
            ...
            <div class="wizard my-2">
                ...
                <form action="<?= url('/admin/add-on-content/update') ?>">
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <?php include_once basePath('/views/admin/ad-on-content/assets/edit.templates_tab.view.php') ?>
                    </div>
                </form>
            </div>
        ...
        <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary background-blue" id="ad-on-update">Update</button>
        </div>
...
<script>
    ...
    $('button#ad-on-update').off('click');
    $('button#ad-on-update').on('click', async function storeAddOn(e){
        e.preventDefault();
        tinymce.triggerSave();
        const btn = $(this);
        ...
        try{
            ...
            const event = new CustomEvent('updateAddOnSuccessEvent',  {
